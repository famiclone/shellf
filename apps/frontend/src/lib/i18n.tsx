...
const en = {
  ...
  "settings.scraperHint":
    "ScreenScraper developer credentials used to look up games by ROM hash. Stored in the database (env vars still work as fallback).",
  ...
  "platforms.createKind": "Kind (optional)",
  "platforms.createKindOptional": "Default / none",
  "platforms.createCustomKind": "Create a custom kind",
  "platforms.createKindName": "Kind name",
  "platforms.createKindNamePlaceholder": "Figure",
  "platforms.createKindFeatures": "Features",
  "platforms.createSubmit": "Create group",
  "platforms.createErrorName": "Enter a group name",
  "platforms.createErrorKindName": "Enter a kind name",
...
const uk: Messages = {
  ...
  "settings.scraperHint":
    "Облікові дані розробника ScreenScraper для пошуку ігор за хешем ROM. Зберігаються в базі (env-змінні лишаються як запасний варіант).",
  "settings.scraperSoftname": "Softname",
  "settings.scraperDevId": "Developer ID",
  "settings.scraperDevPassword": "Developer password",
  ...
  "platforms.createKind": "Тип (опційно)",
  "platforms.createKindOptional": "За замовчуванням / без типу",
  "platforms.createCustomKind": "Створити власний тип",
  "platforms.createKindName": "Назва типу",
  "platforms.createKindNamePlaceholder": "Фігурка",
  "platforms.createKindFeatures": "Можливості",
  "platforms.createSubmit": "Створити групу",
  "platforms.createErrorName": "Вкажіть назву групи",
  "platforms.createErrorKindName": "Вкажіть назву типу",
