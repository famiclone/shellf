...
const en = {
  ...
  "dashboard.topExpensive": "Most expensive",
  "dashboard.topCheapest": "Cheapest",
  "dashboard.noMarketPrices": "No PriceCharting prices yet",
  ...
  "items.view": "View mode",
  "items.viewGrid": "Grid view",
  "items.viewList": "List view",
  "items.showAllInGroup": "Show all {count}",
  ...
  "editGame.descriptionHint": "From ScreenScraper or enter manually",
  "editGame.tags": "Tags",
  ...
  "game.rotateCover": "Rotate cover 90°",
  "game.info": "Info",
  "game.region": "Region",
  ...
  "assets.coverFromScraper": "From ScreenScraper",
  "assets.deleteCover": "Remove this cover from the item?",
...
const uk: Messages = {
  ...
  "dashboard.topExpensive": "Найдорожчі",
  "dashboard.topCheapest": "Найдешевші",
  "dashboard.noMarketPrices": "Ще немає цін з PriceCharting",
  ...
  "items.view": "Режим перегляду",
  "items.viewGrid": "Сітка",
  "items.viewList": "Список",
  "items.showAllInGroup": "Показати всі {count}",
  ...
  "editGame.descriptionHint": "З ScreenScraper або введіть вручну",
  "editGame.tags": "Теги",
  ...
  "game.rotateCover": "Повернути обкладинку на 90°",
  ...
  "assets.screenscraper": "ScreenScraper",
  "assets.cover": "Обкладинка",
  "assets.noCover": "Немає обкладинки",
  "assets.coverFromScraper": "З ScreenScraper",
  "assets.deleteCover": "Прибрати цю обкладинку з айтема?",
